...
# Your legal name
first_name = "Chao"                # Your first name in quotes Eg: "First", "Sai"
middle_name = "Charlie"            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Guan"                 # Your last name in quotes Eg: "Last", "Golla"
...
current_city = "Braintree, MA"     # Los Angeles, San Francisco, etc.
'''
